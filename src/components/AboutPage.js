    ...
    return (
        <div className="AboutPageBox">
            ...
            <div className="Intro">
                ...
                <p>"Ubiquitous Gesture" is a concept that gestures can be made to appear anytime and everywhere.<br></br><br></br>
                    ...
                    Imagine doing a swipe with your feet or pinching with lips... Gestures that can be "transferred" from hands to other <i>modalities </i>
                    ...
                    humans' modalities are engaged in different situations. </p>
            </div>

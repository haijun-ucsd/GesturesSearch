...
export default function WaitingRoom(props) {
  ...
  useEffect(() => {
    ...
    console.log(props.addedPics);
    console.log("addedPicsUrl ↓");
    console.log(props.addedPicsUrl);
    console.log("formDataList ↓");
    console.log(props.formDataList);
    console.log("completePercentages ↓");
    console.log(props.completePercentages);
    console.log("addedLabels ↓");
    console.log(props.addedLabels);
    console.log("picAnnotation ↓");
    console.log(props.picAnnotation);
    console.log("」\n ");
  }, [
    props.addedPics,
    props.addedPicsUrl,
  ...
  return (
    <div className="WaitingRoom">
        ...
        <div className="WaitingRoomControl_addpic">
          <div id="add-pic-btn-div">
            ...
            <input
              ...
              multiple
              accept="image/*,.heic"
              // TODO: cannot display heic yet, possible workaround: https://shkspr.mobi/blog/2020/12/coping-with-heic-in-the-browser/
      ...
      {clickedUrl != "" ? (
        <UploadPopUp
          url={clickedUrl}
          dataIndex={props.addedPicsUrl.findIndex(
